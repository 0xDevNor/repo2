...
async function surprisinglyShortAttentionSpan() {
  ...
  workEl.scrollTop = 0; // Scroll to the top of the work element
  styleEl.scrollTop = 0; // Scroll to the top of the style element
  pgpEl.scrollTop = 0; // Scroll to the top of the pgp element
}
